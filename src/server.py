...
if __name__ == '__main__':
    ...
    root = RecipePage(db['team'])
    root.team = RecipePage(db['team'], "team")
    root.repertoire = RepertoirePage(db['team'])

    root.food4action = RecipePage(db['food4action'], "food4action")
    root.food4action.repertoire = RepertoirePage(db['food4action'], "food4action")

    root.cutiemeow = RecipePage(db['cutiemeow'], "cutiemeow")
    root.cutiemeow.repertoire = RepertoirePage(db['cutiemeow'], "cutiemeow")
